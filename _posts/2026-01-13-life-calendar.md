...
![Life calendar screenshot](/assets/images/2026-01-13-211718_hyprshot.png)

It's pure JavaScript and just runs on GitHub Pages. Fun note: once you have a custom domain configured on `wrathagom.github.io`, other repos with GitHub Pages enabled will automatically show up at `https://wrathagom.github.io/{repo-name}`. In this case, the repo is located at [https://github.com/wrathagom/life-calendar](https://github.com/wrathagom/life-calendar), while the life calendar itself is running at:

> [http://calebmkeller.com/life-calendar/](http://calebmkeller.com/life-calendar/)
